...
class PasswordCheck(models.Model):
    ...
    """
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='password_checks')
    hash_prefix = models.CharField(max_length=5, help_text="First 5 chars of SHA1 hash (k-anonymity)")
    label = models.CharField(max_length=100, blank=True, help_text="Optional label (e.g., 'Gmail password')")
