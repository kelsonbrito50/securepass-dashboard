...
import { Shield, Home, LogOut, Menu, X, Moon, Sun } from 'lucide-react';
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center gap-4">
              ...
              <button
                onClick={toggleTheme}
                className="flex items-center gap-2 px-4 py-2 text-gray-400 hover:text-white dark:hover:text-white transition-colors"
